...
routes.post("/admin/recipes/recipes", multer.array("photos", 5), recipes.post); // Cadastrar nova receita
routes.put("/admin/recipes/recipes", multer.array("photos", 5), recipes.put); // Editar uma receita
